  ...
  const [blogs, setBlogs] = useState([
    {
      ...
      category: "FEATURES",
      excerpt: "Social media was meant to give people a voice. Somewhere along the way, it became a stage.",
      readTime: "3 min read",
    ...
    },
    {
      ...
      excerpt: "A mission-driven team working together across strategy, tech, and execution to redefine social expression.",
      readTime: "4 min read",
    ...
    },
    {
      ...
      category: "FEATURES",
      excerpt: "Explore anonymous expression, live polls, and judgment-free conversations—built for India.",
      readTime: "2 min read",
    ...
    },
    {
      ...
      date: "February 10, 2026",
      category: "SECURITY",
      excerpt: "Anonymous comments on Kalesh protect users and keep discussions opinion-driven.",
      readTime: "5 min read",
            ...
            <div className="header-right">
              <div className="subscribe-box">
                ...
                <p className="privacy-text">
                  Your information will be used in accordance with Kalesh's Privacy Policy.
                </p>
              </div>
            </div>
          </div>
            ...
            {featuredBlogs.map(blog => (
              <div className="featured-card" key={blog.id}>
                <div className="featured-image">
                  ...
                  <div className="category-tag" style={{ backgroundColor: blog.color }}>
                    {blog.category}
                  </div>
                </div>
      ...
      <section className="recent-section">
        <div className="container-fluid">
          <div className="section-header">
            ...
            <a href="/blog/viewpage" className="view-all">View all posts →</a>
          </div>
